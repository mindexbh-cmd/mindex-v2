# Mindex Portal
from flask import Flask, render_template_string, make_response, request, jsonify, session, redirect, g
...
@login_required
def dashboard():
    return render_template_string(APP_HTML, user=dict(session["user"]))
